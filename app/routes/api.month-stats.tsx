...
export const config = {
  ...
  export async function loader({request}: LoaderFunctionArgs) {
    ...
    console.log("[MONTHS STATS] Current weather in Brittany : " + bzhAsw.weather[0].main)
    const bzhRain = bzhAsw.weather[0].main == "Thunderstorm" || bzhAsw.weather[0].main == "Drizzle" || bzhAsw.weather[0].main == "Rain"
    ...
    console.log("[MONTHS STATS] Current weather in Normandy : " + nmdAsw.weather[0].main)
    const nmdRain = nmdAsw.weather[0].main == "Thunderstorm" || nmdAsw.weather[0].main == "Drizzle" || nmdAsw.weather[0].main == "Rain"
